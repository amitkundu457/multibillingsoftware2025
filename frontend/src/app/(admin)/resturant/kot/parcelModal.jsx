        ...
        <div className="min-h-screen p-6 bg-white md:p-10">
          ...
          <div className="flex items-center gap-3 mb-6">
            <select
              ...
              className="w-48 px-3 py-2 text-gray-700 bg-white border border-r-4 border-purple-900 rounded-lg shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-200 focus:outline-none"
            >
              ...
              {showBarcodeNumber && (
                <div className="flex gap-2">
                  <input
                    ...
                    className="p-2 bg-red-100 border border-red-500 rounded outline-none w-3/7 focus:border-red-700"
                  />
