...
const StockListTable = () => {
  ...
  useEffect(() => {
    fetch("  https://apibrize.brizindia.com/api/purchase-returns/")
  ...
  return (
    <div className="overflow-x-auto p-4 bg-gray-100 min-h-screen">
      <div className="mb-4 flex justify-between items-center">
        <h2 className="text-xl font-semibold">Purchase Return List</h2>
        <input
          type="text"
          placeholder="Search..."
      ...
      <table className="min-w-full bg-white border border-gray-200 shadow-lg rounded-lg overflow-hidden">
        ...
        <tbody>
          {filteredData.map((item) => (
            <tr
              key={item.id}
              className="text-left border-b hover:bg-gray-100 transition"
            >
              ...
              <td className="py-2 px-4 border">{item.reasons}</td>
              ...
              <td className="py-2 px-4 border">
                <button className="bg-blue-500 text-white px-4 py-1 rounded shadow hover:bg-blue-600 transition">
                  Action
                </button>
              </td>
            </tr>
