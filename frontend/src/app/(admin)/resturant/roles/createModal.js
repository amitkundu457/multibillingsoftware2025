    ...
    const fetchPermissions = async () => {
      try {
        const response = await axios.get(
          "  https://apibrize.brizindia.com/api/permission"
        );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (editingRole) {
        ...
        await axios.post(
          `  https://apibrize.brizindia.com/api/roles/${editingRole.id}`,
          roleData,
          {
            headers: {
        ...
        // Create new role
        await axios.post("  https://apibrize.brizindia.com/api/roles", roleData, {
          headers: {
            "Content-Type": "application/json",
          },
        });
