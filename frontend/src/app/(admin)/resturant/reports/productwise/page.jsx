...
const ProductWise = () => {
    ...
    const fetchData = async () => {
      try {
        const response = await axios.get(
          " https://apibrize.brizindia.com/api/Saloon-products",
          {
  ...
  const handleDownloadPDF = async (type) => {
    try {
      const url = ` https://apibrize.brizindia.com/api/product-services-pdf?format=${type}&start_date=${startDate}&end_date=${endDate}`;
  ...
  return (
    <div className="p-6 bg-gray-50 min-h-screen">
      ...
      <div className="flex justify-between items-center bg-gray-200 py-6 px-8 rounded-lg shadow-md">
        <p className="font-bold text-2xl text-gray-800">Product Report</p>
        <div>
          <button
