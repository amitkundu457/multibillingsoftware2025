...
const Page = () => {
  ...
  const fetchStocks = async () => {
    ...
    try {
      const res = await axios.get(" https://apibrize.brizindia.com/api/stock-List", {
        headers: { Authorization: `Bearer ${token}` },
      });
  ...
  const handleManualSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      await axios.post(" https://apibrize.brizindia.com/api/stock/add", manualForm, {
        headers: { Authorization: `Bearer ${token}` },
      });
      fetchStocks();
  ...
  const handleCsvUpload = async () => {
    ...
    try {
      const res = await axios.post(" https://apibrize.brizindia.com/api/bulk-upload-stock", formData, {
        headers: {
  ...
  const handleDelete = async (id) => {
    ...
    try {
      await axios.delete(` https://apibrize.brizindia.com/api/delete-stock/${id}`, {
        headers: {
          Authorization: `Bearer ${token}`
        },
      });
