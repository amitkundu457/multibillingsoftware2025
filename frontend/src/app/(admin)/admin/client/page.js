...
const ClientManagement = () => {
  ...
  const fetchRoles = async () => {
    try {
      const response = await axios.get('  https://apibrize.brizindia.com/api/roles');
  ...
  const fetchClients = async () => {
    try {
      const response = await axios.get("  https://apibrize.brizindia.com/api/user-infos");
  ...
  useEffect(() => {
    const fetchDistributors = async () => {
      try {
        const response = await axios.get("  https://apibrize.brizindia.com/api/distributors/search");
  ...
  const onSubmitEdit = async (data) => {
    ...
    try {
      ...
      if (response.status === 200) {
        ...
        const updatedClients = await axios.get("  https://apibrize.brizindia.com/api/user-infos");
