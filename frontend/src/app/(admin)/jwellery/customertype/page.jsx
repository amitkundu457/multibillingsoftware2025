...
//   const [typedata, setCustomerTypeData] = useState([]);
...
// Create Modal for Adding Customer Type
export const Model = ({ onClose, onSave }) => {
  const [inputData, setInputData] = useState({ name: "" });
...
// Edit Modal for Updating Customer Type
export const EditModel = ({ onClose, onSave, id }) => {
  const [inputData, setInputData] = useState({ name: "" });
