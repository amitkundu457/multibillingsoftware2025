...
//           }
//           .barcode-card {
//             width: 70mm; /* Increased width */
//             height: 30mm; /* Increased height */
//             padding: 2mm;
...
//                       <div>NWT:{item.nwt} GWT:{item.gwt} DWT:{item.diamond_details}</div>
...
//                     <div
//                       key={key}
//                       className="barcode-card border relative p-2"
//                     >
//                       <input
//                         type="checkbox"
