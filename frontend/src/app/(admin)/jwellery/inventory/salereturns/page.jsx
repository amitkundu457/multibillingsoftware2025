 ...
 export default function PurchaseReturn() {
      ...
      return;
       ...
       try {
         const response = await fetch(
           "  https://apibrize.brizindia.com/api/sale-returns",
           {
   ...
   const fetchCustomers = async () => {
       try {
        ...
        //  const { data } = await axios.get(" https://apibrize.brizindia.com/api/suppliers", config);
        const res  = await axios.get(" https://apibrize.brizindia.com/api/suppliers", config);
   ...
   const handleSubmit = async (e) => {
     ...
     try {
       const response = await fetch("  https://apibrize.brizindia.com/api/sale-returns", {
         method: "POST",
