...
//     try {
//       const response = await axios.get(" https://apibrize.brizindia.com/api/billcount", {
...
//           ` https://apibrize.brizindia.com/api/billcount/${editingItem.id}`,
//           data,
//           {
//             headers: { Authorization: `Bearer ${token}` },
//           }
...
//           " https://apibrize.brizindia.com/api/billcount",
//           data,
//           {
//             headers: { Authorization: `Bearer ${token}` },
//           }
...
export default function Home() {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      await axios.post(" https://apibrize.brizindia.com/api/billcount", data, {
        headers: { Authorization: `Bearer ${token}` },
      });
      fetchBillCount();
      reset();
