  ...
  return (
    <div className="p-6 bg-gray-50 min-h-screen">
      ...
      <div className="flex justify-between items-center bg-gray-200 py-6 px-8 rounded-lg shadow-md">
        <div>
          <p className="font-bold text-2xl text-gray-800">Closing Stock</p>
        </div>
        <div>
        ...
        <table className="w-full text-left bg-white rounded-lg shadow-lg overflow-hidden">
          <thead className="   bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 text-white font-semibold">
            <tr>
              ...
              <th className="py-3 px-4 border-b">Item Code</th>
              <th className="py-3 px-4 border-b">GWT</th>
              <th className="py-3 px-4 border-b">NWT</th>
              <th className="py-3 px-4 border-b">WT Diff.</th>
              <th className="py-3 px-4 border-b">PCS</th>
