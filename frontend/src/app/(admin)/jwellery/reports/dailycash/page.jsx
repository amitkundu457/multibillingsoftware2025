...
//       try {
//         const response = await axios.get(" https://apibrize.brizindia.com/api/cashreport", {
...
//     try {
//       setLoading(true);
//       const res = await axios.get(" https://apibrize.brizindia.com/api/paymenetreport", {
//         params: { date },
//         headers: {
  ...
  const fetchSummary = async () => {
    ...
    try {
      ...
      const res = await axios.get(
        " https://apibrize.brizindia.com/api/paymenetreport",
        {
          params,
          headers: {
