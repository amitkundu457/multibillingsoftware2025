...
import { useRouter } from 'next/navigation';
 const Page = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post('  https://apibrize.brizindia.com/api/ratemaster', data,
                {
            ...
            router.push('/jwellery/todayrates'); // Redirect to another page after success
        } catch (error) {
