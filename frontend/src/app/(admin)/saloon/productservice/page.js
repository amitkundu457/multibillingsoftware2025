...
const ItemManagement = () => {
  ...
  const fetchCategory = async () => {
    ...
    try {
      const response = await axios.get(" https://apibrize.brizindia.com/api/product-service-groups", {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      const response=await axios.get(" https://apibrize.brizindia.com/api/product-and-service",
        {
          headers: { Authorization: `Bearer ${token}` },
        }
  ...
  const handleSave = async (e) => {
    ...
    try {
      if (currentItem) {
        ...
        await axios.post(` https://apibrize.brizindia.com/api/update-product/${currentItem.id}`,formDataToSend,
          {
            headers: { Authorization: `Bearer ${token}` },
          }
        )
        ...
        await axios.post(` https://apibrize.brizindia.com/api/Saloon-product-services`,formDataToSend,
          {
            headers: { Authorization: `Bearer ${token}` },
          }
        )
