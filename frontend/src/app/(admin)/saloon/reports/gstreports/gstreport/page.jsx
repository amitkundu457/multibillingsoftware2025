  ...
  return (
    <div className="p-6 bg-gray-50 min-h-screen">
      ...
      <div className="flex justify-between items-center bg-gray-200 py-6 px-8 rounded-lg shadow-md">
        <div>
          <p className="font-bold text-2xl text-gray-800">GST report</p>
        </div>
        <div>
        ...
        <table className="w-full text-left bg-white rounded-lg shadow-lg overflow-hidden">
          <thead className="bg-gray-100 text-gray-700 font-semibold">
            <tr>
              ...
              <th className="py-3 px-4 border-b">Voucher Date</th>
              <th className="py-3 px-4 border-b">Bill no.</th>
              <th className="py-3 px-4 border-b">Party Name</th>
              <th className="py-3 px-4 border-b">GSTIN</th>
              <th className="py-3 px-4 border-b">Sale <br />0% </th>
              <th className="py-3 px-4 border-b">Sale <br />5%</th>
              <th className="py-3 px-4 border-b">Sale <br />12%</th>
              <th className="py-3 px-4 border-b">Sale <br />18%</th>
              <th className="py-3 px-4 border-b">Sale <br />28%</th>
              <th className="py-3 px-4 border-b">CGST</th>
              <th className="py-3 px-4 border-b">SGST</th>
              <th className="py-3 px-4 border-b">IGST</th>
