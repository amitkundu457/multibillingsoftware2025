...
export default function PurchaseReturn() {
  ...
  useEffect(() => {
    const fetchSalesReturn = async () => {
      try {
        const response = await axios.get(" https://apibrize.brizindia.com/api/sale-returns", {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post(" https://apibrize.brizindia.com/api/saloon-sale-returns", formData, {
        headers: {
