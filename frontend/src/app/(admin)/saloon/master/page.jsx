...
const MasterMenu = () => {
  ...
  return (
    <div className="absolute top-0 bottom-0 left-0 right-0 bg-gray-100 ">
      <div className="py-3 text-xl font-bold text-center text-white bg-green-500 rounded">
        Master Menu
      </div>
      <div className="mt-6 space-y-4 px-[28rem] overflow-y-auto h-[33rem]">
        {menuItems
          ...
          .map((item, index) => (
            <div
              key={index}
              className="flex items-center justify-between p-1 bg-white border-2 border-green-500 rounded-lg shadow hover:shadow-lg"
            >
              <div className="flex items-center space-x-4">
                <div className="flex items-center justify-center font-bold text-white bg-green-500 rounded-full w-9 h-9">
                  {item.count}
                </div>
                <div className="text-[14px] font-medium">{item.name}</div>
              </div>
              <Link href={item.link}>
                <span className="flex items-center justify-center text-xl font-bold text-white bg-green-500 rounded-full w-9 h-9">
                  +
                </span>
              </Link>
            </div>
