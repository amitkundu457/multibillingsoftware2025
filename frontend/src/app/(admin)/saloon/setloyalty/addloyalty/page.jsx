      ...
      <div className="bg-white shadow-lg rounded-xl p-6 w-full max-w-md">
        ...
        <div className="mb-4">
          <label className="block font-medium text-gray-600">
            Min Value of invoice for Earning Points:
          </label>
          <input
            type="number"
        ...
        <div className="mb-4">
          ...
          />
          {selectedDate && (
            <p className="text-gray-500 mt-1">Selected Date: {selectedDate}</p>
          )}
        </div>
        ...
        <button
          onClick={handleSave}
          className="w-1/2  bg-orange-500 text-white font-semibold py-2 rounded-lg hover:bg-blue-600"
        >
          Save
        </button>
      </div>
