...
const Loyalty = () => {
  ...
  const fetchloyalty = async () => {
    try {
      const response = await axios.get("  https://apibrize.brizindia.com/api/loyalty/");
  ...
  const handleSaveTax = async () => {
    if (isEditMode) {
      // Update existing tax
      try {
        await axios.post(`  https://apibrize.brizindia.com/api/loyalty/${modalData.id}`, modalData);
        fetchloyalty();
      ...
      // Create new tax
      try {
        await axios.post("  https://apibrize.brizindia.com/api/loyalty/", modalData);
        fetchloyalty();
        setIsModalOpen(false);
      } catch (error) {
