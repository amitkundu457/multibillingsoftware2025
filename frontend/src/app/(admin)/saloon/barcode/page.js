...
const BarcodeData = () => {
  ...
  const fieldTitles = {
    ...
    // image: "Image",
    basic_rate: "Basic Amount",
    purchase_rates: "Purchase Amount",
    // mrp: "MRP",
    sale_rate: "Sale Amount",
    // gm: "Gram",
  ...
  const handleDownloadSample = () => {
    window.location.href = "  https://apibrize.brizindia.com/api/download-sample-barcode";
  };
  ...
  const fetchPurity = async () => {
    ...
    const response = await axios.get(" https://apibrize.brizindia.com/api/purity",{ headers });
  ...
  const barocdeCount = async () => {
    ...
    const response = await axios.get(" https://apibrize.brizindia.com/api/countByAuthenticatedUser",{ headers });
