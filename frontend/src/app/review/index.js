...
const ReviewForm = () => {
    ...
    useEffect(() => {
        ...
        const fetchShop = async () => {
            try {
                const response = await axios.get(`  https://apibrize.brizindia.com/api/user-infos-slug/${slug}`);
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            await axios.post("  https://apibrize.brizindia.com/api/reviews", formData);
            setSubmitted(true);
        } catch (error) {
