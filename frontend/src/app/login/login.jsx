      ...
      <div className="w-full max-w-md p-8 bg-white rounded-lg ">
        ...
        <form onSubmit={handleLogin}>
          ...
          <div className="mb-4 relative">
            ...
            />
            <button
              className=" text-[30px] absolute top-[30px] right-[10px]"
              type="button"
              onClick={() => setShowPassword(!showPassword)}
            >
              {showPassword ? <IoEyeSharp className="" /> : <IoMdEyeOff />}
            </button>
          </div>
        ...
        <div className="flex space-x-2 mt-4">
          <div>
            <div className=" sm:text-xl text-xs ">
              ...
              <a
                href="http://distributer.brizindia.com/"
                className="bg-green-500 p-1 text-xs sm:text-sm hover:text-gray-600 sm:p-2 text-white rounded"
              >
                click here
              </a>
            </div>
