...
export default function CategorySale() {
  ...
  useEffect(() => {
    ...
    axios
      .get(" https://apibrize.brizindia.com/api/categoryrate", {
        ...
        <div className="overflow-x-auto">
          <table className="min-w-full table-auto border border-purple-300">
            <thead className="bg-purple-200">
              <tr>
                <th className="px-4 py-2 text-left border-b border-purple-300 text-purple-800">
                  Category
                </th>
                <th className="px-4 py-2 text-left border-b border-purple-300 text-purple-800">
                  Count
            ...
            <tbody>
              {Object.entries(categoryCount).map(([category, count]) => (
                <tr key={category} className="bg-white even:bg-purple-50">
                  <td className="px-4 py-2 border-b border-purple-200">
                    {category}
                  </td>
                  <td className="px-4 py-2 border-b border-purple-200">
                    {count}
