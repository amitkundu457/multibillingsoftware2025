...
if (!token) {
  ...
  return;
    ...
    try {
      ...
      const orderResponse = await axios.get(" https://apibrize.brizindia.com/api/orders/today",
        {
      ...
      const enquiryResponse = await axios.get(" https://apibrize.brizindia.com/api/customerequires-count",
        {
          headers: { Authorization: `Bearer ${token}` },
        }
