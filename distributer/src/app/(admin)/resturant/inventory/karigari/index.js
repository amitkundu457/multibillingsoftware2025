...
function Page() {
  ...
  const { data: karigariData, isLoading: loading } = useKarigari();
      ...
      <div className="flex px-6 py-1">
        ...
        <div className="flex items-end p-2 flex-1 justify-end relative">
          ...
          >
            <li>
              <Link
                href="/admin/inventory/karigari/issue"
            ...
            <li>
              <Link
                href="/admin/inventory/karigari/receive"
                className="text-sm text-zinc-700 flex justify-between items-center p-2"
              >
                <span>Received</span>
                <FaChevronRight />
                ...
                <tr key={kgi.id}>
                  ...
                  <td className="px-3 py-3">
                    <div className="flex gap-4 items-center">
                      <Link
                        href={`/admin/inventory/karigari/issue/${kgi.id}`}
